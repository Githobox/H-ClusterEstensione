...
public abstract class BaseSceneController {
     ...
     */
    private static final String APPLICATION_TITLE = "H-Cluster Client";
    /**
     * Percorso immagine icona.
     */
    private static final String ICON_PATH = "/resources/images/icona.png";
    /**
    ...
    public void closeConnection() {
        if(connessioneSocket != null) {
            try{
                this.connessioneSocket.getOutputStream().writeObject(4);
            } catch (IOException e) {
