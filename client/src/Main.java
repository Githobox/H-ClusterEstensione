import gui.HClusterClient;
/**
 * Main è la classe principale per l'applicazione client.
 * Questa classe avvia l'applicazione client e carica la scena di connessione.
 * Questa classe è stata creata per consentire l'avvio dell'applicazione JavaFX.
 */
public class Main {
    /**
